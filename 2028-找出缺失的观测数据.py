...
LastEditTime: 2024-05-27 11:40:02
...
'''
核心思路：由 nnn 个在 [1,6] 范围内的整数组成且这 n 个整数之和为 missingsum ， 记 quotient = missing / n 的向下取整，remainder = missingsum mod n，则可以构造一种符合要求的答案：在缺失的 nnn 个观测数据中，有 remainder 个观测数据是 quotient+1 ，其余观测数据都是 quotient 。
